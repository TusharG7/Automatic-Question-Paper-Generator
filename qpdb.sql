...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2019 at 03:27 PM
...
--
-- Table structure for table `tchr_sub_bridge`
--

CREATE TABLE `tchr_sub_bridge` (
  `sub_id` int(11) NOT NULL,
...
INSERT INTO `teachers` (`t_id`, `t_name`, `t_password`) VALUES
(1, 'Jyoti', 'abcd123');
